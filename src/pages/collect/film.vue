<template>
    <div class="film-list">
        ...
        <div class="container">
            ...
            <div class="banner" v-else v-for="(item, index) in filmArticleList" v-bind:key="item._id" @click="toArticleDetail(item)">
...
<script>
    ...
    export default {
        ...
        created(){
            this.filmArticleList = this.$route.params
        },
        watch: {
            $route (to, from) {
                ...
                this.filmArticleList = to.params
            }
        },
        methods: {
            goBack(){
