<template>
    <div class="sound-list">
        ...
        <div class="input-search">
            <div class="main">
                <input type="text" v-focus="focused" @focus="searchFocus" @blur="searchBlur" v-model="searchTxt" placeholder="Search Article" ref="soundSearchInput">
                <div class="search-icon" @click="searchSoundArticle"></div>
            </div>
        </div>
        <scroller class="scroller" ref="soundScroller"
                  :on-refresh="refresh"
        ...
        >
            ...
            <div class="container" id="scrollSoundList">
                <div class="banner" v-for="(item, index) in soundArticleList" v-bind:key="item._id" @click="toArticleDetail(item)">
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$axios.getSoundArticleList({current: this.current, isWebApp: true}).then(res => {
                ...
                this.preload(this.soundArticleList.map(item => {
        ...
        watch: {
            searchTxt(newVal){
                this.$axios.getSoundArticleList({current: this.current, searchKey: newVal,  isWebApp: true}).then((res) => {
                    this.soundArticleList = res.data.data.docs
                    console.log('this.soundArticleList',this.soundArticleList)
                })
            }
        ...
        methods: {
            ...
            searchSoundArticle(){
                this.$axios.getSoundArticleList({current: this.current, searchKey: this.searchTxt,  isWebApp: true}).then((res) => {
                    this.soundArticleList = res.data.data.docs
                    console.log('this.soundArticleList',this.soundArticleList)
                })
            }
