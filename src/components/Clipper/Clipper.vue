    ...
    export default {
        ...
        methods: {
            ...
            _initCanvas() {
                ...
                console.log('this.clipperImgWidth',this.clipperImgWidth)
                console.log('clipperClientRect.width',clipperClientRect.width)
                ...
                if (clipperWidth > clipperClientRect.width){
                    clipperWidth = clipperClientRect.width * 0.7
                    clipperHeight = clipperWidth * 3 / 5
                }

                if (clipperHeight < 0) {
                    clipperHeight = 100
                }
                if (clipperHeight > clipperClientRect.height){
            ...
            _clipper() {
                ...
                if (this.clipperImgHeight == this.clipperImgWidth){
                    this.$emit('confirm', imgData, 'avatar');
                }
                else {
                    this.$emit('confirm', imgData, 'bg');
                }
            },
            _cancel() {
                this.$emit('cancel');
